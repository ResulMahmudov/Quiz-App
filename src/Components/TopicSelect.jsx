...
const topics = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none" viewBox="0 0 40 40">
        <path fill="#2FD887" d="M10 2.505a1.25 1.25 0 0 0-1.25 1.25V21.25a5 5 0 0 0 5 5H15v6.25a4.999 4.999 0 0 0 9.615 1.913c.25-.607.38-1.257.38-1.913v-6.25h1.255a5 5 0 0 0 5-5V3.755A1.25 1.25 0 0 0 30 2.505H10Z" />
      </svg>
    ),
  },
  {
    ...
    <div className="w-[90%] max-w-[1500px] mx-auto">
      ...
      <div className="flex justify-between items-start mt-[10%]">
        ...
        <div className="flex flex-col gap-5">
          ...
          {topics.map((topic) => (
            <button key={topic.id} onClick={() => {navigate(`/quiz/${topic.id}`);}} className="flex gap-3 items-center w-[812px] h-20 p-5 font-bold text-[28px] rounded-[20px] bg-white">
              {topic.icon}
              {topic.name}
            </button>
          ))}
